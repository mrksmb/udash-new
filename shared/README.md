...
* `com.smartdroplets.shared.css` - definition of application stylesheets.
* `com.smartdroplets.shared.i18n` - definition of translations used in the application.
* `com.smartdroplets.shared.model` - model classes which are useful in the RPC communication.
* `com.smartdroplets.shared.rpc` - RPC interfaces for bidirectional client-server communication.
